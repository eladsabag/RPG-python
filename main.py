...
#Create some Items
potion = Item("Potions","potion","Heals 50 HP", 50)
hipotion = Item("Hi-Potion", "potion", "Heals 100 HP", 100)
supportion = Item("Super Potion","potion", "Heals 1000 HP", 1000)
elixer = Item("Elixer","elixer","Fully restores HP/MP of one party member", 9999)
hielixer = Item("MegaElixer","elixer","Fully party's HP/MP",9999)
...
player_items = [{"item" : potion,"quantity":15},
                ...
                {"item":supportion,"quantity":5},
                {"item":elixer,"quantity":2},
                {"item":hielixer,"quantity":5}]

#Instantiate People
player1 = Person("Valos:",3260,132,300,34,player_spells,player_items)
player2 = Person("Elad :",4160,188,311,34,player_spells,player_items)
player3 = Person("Nick :",2089,174,288,34,player_spells,player_items)
...
while running:
    ...
    for enemy in enemies:
        ...
        if enemy_choice == 0:
            ...
            print(enemies[enemy].name.replace(" ", "") + " attacks " + players[target].name.replace(" ","") + " for", enemy_dmg)
