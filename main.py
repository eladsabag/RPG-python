...
supportion = Item("Super Potion","potion", "Heals 500 HP", 500)
...
player2 = Person("Elad :",4160,65,60,34,player_spells,player_items)
player3 = Person("Nick :",2089,65,60,34,player_spells,player_items)
